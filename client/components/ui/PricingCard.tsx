  ...
  return (
    <>
      <section className='flex items-center justify-center flex-col py-20 px-4 dark:text-white'>
        ...
        <p className='text-base/7 text-zinc-500 max-w-sm text-center mt-4 dark:text-white'>Please visit the organization for which you want to purchase the credit for.</p>
