...
export default function CreditsDonatedList() {
  ...
  const getJoinedCredits = async () => {
    try {
      ...
      toast.error(t("manageOrganization.credits.error"))
    } finally {
      setLoading(false)
    }
  }
              ...
              credits?.length > 0 ? (
                <div>
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead>{t("manageOrganization.credits.table.name")}</TableHead>
                        <TableHead>{t("manageOrganization.credits.table.package")}</TableHead>
                        <TableHead>{t("manageOrganization.credits.table.credits")}</TableHead>
                        <TableHead>{t("manageOrganization.credits.table.amount")}</TableHead>
                        <TableHead>{t("manageOrganization.credits.table.purchasedAt")}</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {
                ...
                <p>{t("manageOrganization.credits.noCredits")}</p>
              )
            }
          </div>
        )
